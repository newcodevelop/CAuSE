...
print('Saving models to Folder: ./flava_vqax_{}'.format(args.ablation.lower()))

# torch.save(phi1.state_dict(), './flava_esnli_{}/phi1.pt'.format(args.ablation.lower()))
torch.save(phi2.state_dict(), './flava_vqax_{}/phi2.pt'.format(args.ablation.lower()))
torch.save(projection_model.state_dict(), './flava_vqax_{}/projection_model.pt'.format(args.ablation.lower()))
