...
# paths
output_dir = "./qwenvl_lora_classifier_vqax"
...
print('Saving models to Folder: ./qwenvl_vqax_{}_F'.format(args.ablation.lower()))

# torch.save(phi1.state_dict(), './flava_esnli_{}/phi1.pt'.format(args.ablation.lower()))
torch.save(phi2.state_dict(), './qwenvl_vqax_{}_F/phi2.pt'.format(args.ablation.lower()))
torch.save(projection_model.state_dict(), './qwenvl_vqax_{}_F/projection_model.pt'.format(args.ablation.lower()))
