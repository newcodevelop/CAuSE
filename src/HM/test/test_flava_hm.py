...
print('Loading models from Folder: ./flava_hm_{}'.format(args.ablation.lower()))


    
    
phi1.load_state_dict(torch.load('./flava_hm_{}/phi2.pt'.format(args.ablation.lower())))
phi2.load_state_dict(torch.load('./flava_hm_{}/phi2.pt'.format(args.ablation.lower())))
projection_model.load_state_dict(torch.load('./flava_hm_{}/projection_model.pt'.format(args.ablation.lower())))
    

dd = {0: 'not offensive', 1: 'offensive'}
...
if int(args.counterfactual_test)==1:
    ...
    torch.save(gen_vals, f'./generated_samples/{args.ablation}_hm_flava_gen.pt')
