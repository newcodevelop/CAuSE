...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return enc, gl, self.explanation[idx], self.img_path[idx], self.hypothesis[idx]
...
print('Saving models to Folder: ./flava_esnli_{}'.format(args.ablation.lower()))

# torch.save(phi1.state_dict(), './flava_esnli_{}/phi1.pt'.format(args.ablation.lower()))
torch.save(phi2.state_dict(), './flava_esnli_{}/phi2.pt'.format(args.ablation.lower()))
torch.save(projection_model.state_dict(), './flava_esnli_{}/projection_model.pt'.format(args.ablation.lower()))
