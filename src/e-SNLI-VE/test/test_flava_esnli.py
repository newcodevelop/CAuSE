...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        visual_embeds,_,_ = self.feat_vb[os.path.join('/kaggle/input/esnli-ve/imgs/imgs',self.img_path[idx])][0]
        ...
        return enc, gl, self.explanation[idx], self.img_path[idx], self.hypothesis[idx], torch.squeeze(visual_embeds)
...
print('Loading models from Folder: ./flava_esnli_{}'.format(args.ablation.lower()))


    
    
phi1.load_state_dict(torch.load('./flava_esnli_{}/phi2.pt'.format(args.ablation.lower())))
phi2.load_state_dict(torch.load('./flava_esnli_{}/phi2.pt'.format(args.ablation.lower())))
projection_model.load_state_dict(torch.load('./flava_esnli_{}/projection_model.pt'.format(args.ablation.lower())))
