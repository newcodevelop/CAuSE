...
print('Loading models from Folder: ./vb_esnli_{}'.format(args.ablation.lower()))


    
    
phi1.load_state_dict(torch.load('./vb_esnli_{}/phi1.pt'.format(args.ablation.lower())))
phi2.load_state_dict(torch.load('./vb_esnli_{}/phi2.pt'.format(args.ablation.lower())))
projection_model.load_state_dict(torch.load('./vb_esnli_{}/projection_model.pt'.format(args.ablation.lower())))
...
x_cfs2 = TensorDataset(x_cfs_2.cpu(),C2.cpu(),X2_ii.cpu(), X2_tti.cpu(), X2_am.cpu(), X2_ve.cpu(), X2_vtti.cpu(), X2_vam.cpu())
